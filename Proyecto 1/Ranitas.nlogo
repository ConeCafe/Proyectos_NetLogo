...
to setup
  ...
  set-default-shape ranas_amarillas "turtle"
  set-default-shape ranas_rojas "turtle"
  set-default-shape ranas_azules "turtle"

  ;;Se generan las casillas del tablero
  ask patches [
    sprout-casillas 1 [set color white]
    set pcolor gray
  ]
  ;;Se generan las primeras ranas, las verdes, estas no tienen comprobacion de que exista otra rana en la casilla a excepcion de las verdes mismas.
  ask n-of rangen patches with [not any? ranas_verdes-here] [
    sprout-ranas_verdes 1 [
     set color green
    ]
  ]
  ;;Se generan las ranas amarillas de manera que antes se compruebe que no hay ninguna rana verde en la casilla ni otra amarilla. El procedimiento es parecido con las siguientes ranas solo que añadiendo más variables
  ask n-of rangen-yell patches with [not any? ranas_verdes-here and not any? ranas_amarillas-here] [
      sprout-ranas_amarillas 1 [
      set color yellow
      ]
  ]
  ask n-of rangen-red patches with [not any? ranas_verdes-here and not any? ranas_amarillas-here and not any? ranas_rojas-here] [
      sprout-ranas_rojas 1 [
      set color red
      ]
  ]
ask n-of rangen-blue patches with [not any? ranas_verdes-here and not any? ranas_amarillas-here and not any? ranas_rojas-here and not any? ranas_azules] [
      sprout-ranas_azules 1 [
      set color blue
      ]
  ]
reset-ticks
